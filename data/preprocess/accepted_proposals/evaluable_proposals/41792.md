...
@robpike 
IMHO, if the flag name does not cause any problems in all forms listed in the [document](https://github.com/golang/go/blob/16328513bfb12d96e8f33fc37f816e1441027135/src/flag/flag.go#L38-L59), it’s a valid flag name. Otherwise, it's an invalid flag name.
...
My opinion is:
⛔ :  adding a panic to `FlagSet.Var` is not okay, a breaking change of questionable benefit
