...
--- Comment #29 by janflyborg ---
I have seen the same thing with printouts from a previous run with _GODEBUG=gctrace=1_, being printed, even if I start without that environment variable, later on (please see https://groups.google.com/g/golang-nuts/c/UP9hIrvqDj4 for a better explanation).
