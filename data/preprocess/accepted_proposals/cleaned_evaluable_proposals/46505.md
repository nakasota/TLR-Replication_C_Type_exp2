...
Sure, but the ship has already sailed on that one. 😅 Given that we _already have_ array values, it doesn't seem particularly _more_ confusing to allow conversions to them.
...
If you've decided prematurely to use an array, you're probably just as likely to end up with a tangle of pointers and conversions copied from the Web as to arrive at the correct solution of “stick to slices”. So maybe it's better to confine the user's confusion to “array or slice?” and not _also_ throw pointers into the mix..?
