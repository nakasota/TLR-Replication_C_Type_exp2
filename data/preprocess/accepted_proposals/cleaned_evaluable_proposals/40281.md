...
@fatih Isn't this what the go language version in the go.mod file is for? Can't you just use the new style if version ≥ 1.16, and otherwise stick with the old one?
