...
--- Comment #20 by magical ---
SliceData doesn't seem to have been completely specified in this thread. I assume its signature would be
```
SliceData([]ArbitraryType) *ArbitraryType
```
That is, like `unsafe.Sizeof` and other functions in the unsafe package it acts as sort of a pseudo-generic function that accepts any type but doesn't take any actual type parameters. And that it returns `*T` rather than say `unsafe.Pointer`.

Do I have that right?

--- Comment #21 by ianlancetaylor ---
Good point.  Your suggestion sounds right, as it roughly corresponds to the opposite of `unsafe.Slice`.

--- Comment #22 by gopherbot ---
Change https://go.dev/cl/423594 mentions this issue: `cmd/compile,go/types: implement unsafe.String`

--- Comment #23 by gopherbot ---
Change https://go.dev/cl/423614 mentions this issue: `go/types: implement unsafe.String`

--- Comment #24 by gopherbot ---
Change https://go.dev/cl/423674 mentions this issue: `cmd/compile: implement unsafe.StringData`

--- Comment #25 by gopherbot ---
Change https://go.dev/cl/423675 mentions this issue: `go/types: implement unsafe.StringData`

--- Comment #26 by gopherbot ---
Change https://go.dev/cl/423714 mentions this issue: `cmd/compile: implement unsafe.SliceData`

--- Comment #27 by gopherbot ---
Change https://go.dev/cl/423715 mentions this issue: `go/types: implement unsafe.SliceData`

--- Comment #28 by gopherbot ---
Change https://go.dev/cl/423734 mentions this issue: `cmd/compile: add support for unsafe.{String,StringData,SliceData}`

--- Comment #29 by gopherbot ---
Change https://go.dev/cl/423735 mentions this issue: `go/types,cmd/compile/internal/types2: add support for unsafe.{String,StringData,SliceData}`

--- Comment #30 by gopherbot ---
Change https://go.dev/cl/423754 mentions this issue: `go/types,cmd/compile/internal/types2: add support for unsafe.{String,StringData,SliceData}`
