...
We agree that editor integration and pkg.go.dev are important. I'm not sure about `gorelease` — presumably you meant `goreleaser` — because I want to be notified _before_ I start writing code, not after. But maybe I'm not understanding the idea there.
