...
Looping in @RomainMuller and @Julio-Guerra who are working on our toolexec based instrumentation project https://github.com/DataDog/orchestrion. Romain is planning to file an issue to explain what we’re doing with -toolexec, why we’re doing it this way, and what challenges we face on the way, and for which we’d appreciate toolchain evolution. We might take you up on the offer for a meeting @mvdan 🙇 
