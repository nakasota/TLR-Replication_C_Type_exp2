...
I think the virtue of having a single universal way of referencing context, since it’s already in use, outweighs the value of making it shorter. I think the fact that this change requires massive diffs across the ecosystem, even if the diffs were simple to prepare, is a point against it as well. 
