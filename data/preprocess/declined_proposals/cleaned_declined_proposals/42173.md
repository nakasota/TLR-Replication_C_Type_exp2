...
Apache Traffic Control's own _Grove_ Caching Proxy will likewise treat read errors as not-in-cache. But it's written in Go, so the decisions here could potentially change that. 😄 
