=== Fetching Proposal: I_kwDOAWBuf85D-8jk ===
Issue URL: https://github.com/golang/go/issues/51225
...
Is https://github.com/golang/go/issues/56776 related to this issue ?  If it is, then I think this behavior change will bring a lot of inconvenience, I often use `go tool compile -S `  to check the generated code, and I think there will be many other users who do the same. 
