=== Fetching Proposal: MDU6SXNzdWU5ODY3NjM0Mjk= ===
Issue URL: https://github.com/golang/go/issues/48152
...
--- Comment #18 by joanlopez ---
Hi there,

I realized that calls to [`net/http2.readFrameHeader`](https://github.com/golang/net/blob/master/http2/frame.go#L236) may end up returning an error due to a bad certificate, that's modelled with a `tls.permanentError`, that holds a `net.OpError` that internally points to an [`alertBadCertificate`](https://cs.opensource.google/go/go/+/refs/tags/go1.21.6:src/crypto/tls/alert.go;l=35).
