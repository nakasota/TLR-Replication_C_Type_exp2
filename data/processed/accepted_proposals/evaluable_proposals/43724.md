=== Fetching Proposal: MDU6SXNzdWU3ODcwMjIzMDg= ===
Issue URL: https://github.com/golang/go/issues/43724
...
The proposal in this issue, to adopt execabs semantics as the os/exec semantics, fixes the problems. Execabs doesn’t _remove_ dot from the PATH lookup. Instead it reports use of dot as an error. This avoids the surprise of running a different program. And the reported error is very clear about what happened. Instead of a generic “program not found” it gives an error that avoids the confusion:
...
--- Comment #30 by rashidulv ---
[Hi am rashidul Islam Your Website Very Interesting and Help full. i am many problem Solving ](www.googlebbd.com)
