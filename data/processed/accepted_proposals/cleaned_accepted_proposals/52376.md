=== Fetching Proposal: I_kwDOAWBuf85H4W_1 ===
Issue URL: https://github.com/golang/go/issues/52376
...
`Value.SetZero`、`Value.SetNil` method and the corresponding test case need to be added, right? If that's all, I'm happy to do it :)
