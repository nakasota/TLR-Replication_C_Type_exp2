...
Issue URL: https://github.com/golang/go/issues/29721
...
> Note that if you have _some_ upper bound, you can already “resize” a `semaphore.Weighted` by acquiring and releasing surplus tokens:
> 
> ```go
> const (
> 	maxCap = […]
