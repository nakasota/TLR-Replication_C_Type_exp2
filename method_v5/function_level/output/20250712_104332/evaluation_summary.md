...
- **Number of Proposals with at least one correct link (precision > 0)**: 220
...
- **Number of Processed Proposals**: 231
- **Number of Proposals with at least one correct link (precision > 0)**: 199
- **Macro Precision**: 0.269
- **Macro Recall**: 0.410
- **Macro F1**: 0.284
...
- **File:** `src/runtime/stubs_wasm.go`
    - Ground Truth Functions (0):
    - Predicted Functions (1):
        - ❌ `pause`
...
- **File:** `test/wasmmemsize.dir/main.go`
    - Ground Truth Functions (0):
    - Predicted Functions (2):
        - ❌ `currentMemory`
        - ❌ `main`

- **File:** `test/wasmmemsize.go`
    - Ground Truth Functions (0):
    - Predicted Functions (0):
...
- **File:** `src/cmd/go/internal/vcweb/vcweb_test.go`
    - Ground Truth Functions (0):
    - Predicted Functions (2):
        - ❌ `TestHelp`
        - ❌ `TestOverview`
...
- **File:** `src/crypto/tls/cache_test.go`
    - Ground Truth Functions (0):
    - Predicted Functions (0):
...
- **File:** `src/crypto/tls/defaults_boring.go`
    - Ground Truth Functions (0):
    - Predicted Functions (1):
        - ❌ `isCertificateAllowedFIPS`

- **File:** `src/crypto/tls/defaults_fips140.go`
    - Ground Truth Functions (0):
    - Predicted Functions (1):
        - ❌ `isCertificateAllowedFIPS`

- **File:** `src/crypto/tls/ech.go`
    - Ground Truth Functions (0):
    - Predicted Functions (1):
        - ❌ `Error`

- **File:** `src/crypto/tls/ech_test.go`
    - Ground Truth Functions (0):
    - Predicted Functions (0):
...
- **File:** `src/crypto/tls/fips140_test.go`
    - Ground Truth Functions (0):
    - Predicted Functions (1):
        - ❌ `fipsHandshake`
...
- **File:** `src/crypto/tls/key_schedule_test.go`
    - Ground Truth Functions (0):
    - Predicted Functions (0):
...
- **File:** `src/crypto/tls/quic_test.go`
    - Ground Truth Functions (0):
    - Predicted Functions (1):
...
- **File:** `src/crypto/tls/ticket_test.go`
    - Ground Truth Functions (0):
    - Predicted Functions (0):
...
- **File:** `src/syscall/types_freebsd.go`
    - Ground Truth Functions (0):
    - Predicted Functions (0):
...
- **File:** `src/cmd/compile/internal/x86/ggen.go`
    - Ground Truth Functions (0):
    - Predicted Functions (2):
        - ❌ `ginsnop`
        - ❌ `zerorange`
...
- **File:** `src/cmd/go/internal/imports/scan.go`
    - Ground Truth Functions (0):
    - Predicted Functions (3):
        - ❌ `ScanDir`
        - ❌ `ScanFiles`
...
- **File:** `src/internal/poll/splice_linux_test.go`
    ...
    - Predicted Functions (4):
        - ❌ `BenchmarkSplicePipe`
        - ❌ `BenchmarkSplicePipeNativeParallel`
        - ❌ `BenchmarkSplicePipePoolParallel`
        - ❌ `TestSplicePipePool`
...
- **File:** `src/syscall/zsyscall_linux_loong64.go`
    - Ground Truth Functions (0):
    - Predicted Functions (2):
        - ❌ `Splice`
        - ❌ `write`
...
- **File:** `src/testing/export_test.go`
    - Ground Truth Functions (0):
    - Predicted Functions (0):
...
- ❌ `src/syscall/zsyscall_linux_mips64x.go`
- ❌ `src/syscall/zsyscall_linux_mipsx.go`
...
- ❌ `src/text/template/export_test.go`
- ❌ `src/text/template/funcs.go`
...
- ❌ `src/internal/cpu/cpu_darwin_x86.go`
