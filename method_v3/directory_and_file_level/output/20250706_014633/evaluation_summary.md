...
- **Number of Proposals with at least one correct link (precision > 0)**: 206
...
- ❌ `src/internal/syscall/unix/sysnum_openbsd.go`
...
- ❌ `src/doc/signal_notunix.go`
- ❌ `src/doc/signal_unix.go`
- ✅ `src/go/build/build.go`
- ❌ `src/go/build/build_test.go`
