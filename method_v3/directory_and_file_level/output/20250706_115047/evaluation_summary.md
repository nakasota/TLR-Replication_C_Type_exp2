...
- **Number of Proposals with at least one correct directory (precision > 0)**: 220
...
- **Number of Processed Proposals**: 231
- **Number of Proposals with at least one correct file (precision > 0)**: 208
...
| **Precision** | **Recall** | **F1-Score** | **Found/Total** |
|-----------|--------|----------|-------------|
| 31.7% | 12.5% | 17.9% | 19/152 |

##### Correct Directories Used for Evaluation

**Correct Directories (13):**
- `src/cmd/asm/internal/asm`
- `src/cmd/compile/internal/abi`
- `src/cmd/compile/internal/ir`
- `src/cmd/compile/internal/ssa`
...
- ❌ `src/cmd/link/internal/ld/mips64.go`
...
| **Precision** | **Recall** | **F1-Score** | **Found/Total** |
|-----------|--------|----------|-------------|
| 91.7% | 37.9% | 53.7% | 11/29 |

##### Correct Directories Used for Evaluation

**Correct Directories (9):**
- `src/cmd/compile/internal/coverage`
- `src/cmd/covdata`
- `src/internal/coverage/calloc`
- `src/internal/coverage/cformat`
...
- ❌ `src/internal/obj/x86/pcrelative_test.go`
- ❌ `src/internal/obj/x86/seh.go`
- ❌ `src/internal/obj/x86/ytab.go`
