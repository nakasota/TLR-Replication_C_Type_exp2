#!/usr/bin/env python3
"""
Method v8: Function Level Link Decision Evaluation

This script evaluates the final function-level link decision results.
It compares the predicted function relevance decisions (Yes/No) against ground truth.
This is the final stage of the method v8 pipeline.
"""
...
def evaluate_link_decision(llm_output_file, ground_truth):
    ...
    # Remove metadata
    if "selected_function_level_localization_output" in llm_data:
        del llm_data["selected_function_level_localization_output"]
