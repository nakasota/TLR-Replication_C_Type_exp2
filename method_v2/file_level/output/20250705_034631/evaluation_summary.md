...
- **Number of Proposals with at least one correct link (precision > 0)**: 212
- **Macro Precision**: 0.689
- **Macro Recall**: 0.694
- **Macro F1**: 0.621
...
**Predicted Directories (27):**
- ❌ `src/cmd/asm/internal/arch`
- ✅ `src/cmd/asm/internal/asm`
- ❌ `src/cmd/asm/internal/flags`
...
**Predicted Directories (85):**
- ❌ `src/cmd/go`
- ❌ `src/cmd/go/internal/auth`
- ❌ `src/cmd/go/internal/base`
- ❌ `src/cmd/go/internal/bug`
- ❌ `src/cmd/go/internal/cache`
- ❌ `src/cmd/go/internal/cfg`
- ❌ `src/cmd/go/internal/clean`
- ❌ `src/cmd/go/internal/covcmd`
- ❌ `src/cmd/go/internal/covcmd/testdata`
- ❌ `src/cmd/go/internal/covcmd/testdata/harness`
- ❌ `src/cmd/go/internal/covcmd/testdata/issue56006`
- ❌ `src/cmd/go/internal/covcmd/testdata/issue59563`
- ❌ `src/cmd/go/internal/covcmd/testdata/small`
- ❌ `src/cmd/go/internal/covdata`
- ❌ `src/cmd/go/internal/covdata/testdata`
- ❌ `src/cmd/go/internal/covdata/testdata/dep`
- ❌ `src/cmd/go/internal/covdata/testdata/prog1`
- ❌ `src/cmd/go/internal/covdata/testdata/prog2`
- ❌ `src/cmd/go/internal/cover`
- ❌ `src/cmd/go/internal/cover/testdata`
- ❌ `src/cmd/go/internal/cover/testdata/directives`
- ❌ `src/cmd/go/internal/cover/testdata/html`
- ❌ `src/cmd/go/internal/cover/testdata/main`
- ❌ `src/cmd/go/internal/cover/testdata/p`
- ❌ `src/cmd/go/internal/cover/testdata/pkgcfg`
- ❌ `src/cmd/go/internal/cover/testdata/pkgcfg/a`
- ❌ `src/cmd/go/internal/cover/testdata/pkgcfg/noFuncsNoTests`
- ❌ `src/cmd/go/internal/cover/testdata/pkgcfg/yesFuncsNoTests`
- ❌ `src/cmd/go/internal/cover/testdata/test`
- ❌ `src/cmd/go/internal/covtest`
- ❌ `src/cmd/go/internal/covtest/testdata`
- ❌ `src/cmd/go/internal/covtest/testdata/harness`
- ❌ `src/cmd/go/internal/covtest/testdata/issue56006`
- ❌ `src/cmd/go/internal/covtest/testdata/issue59563`
- ❌ `src/cmd/go/internal/envcmd`
- ❌ `src/cmd/go/internal/fix`
- ❌ `src/cmd/go/internal/fmtcmd`
- ❌ `src/cmd/go/internal/fsys`
- ❌ `src/cmd/go/internal/generate`
- ❌ `src/cmd/go/internal/godebug`
- ❌ `src/cmd/go/internal/gover`
- ❌ `src/cmd/go/internal/goversion`
- ❌ `src/cmd/go/internal/help`
- ❌ `src/cmd/go/internal/imports`
- ❌ `src/cmd/go/internal/lazytemplate`
- ✅ `src/cmd/go/internal/list`
- ❌ `src/cmd/go/internal/load`
...
- ❌ `src/cmd/go/internal/par`
- ❌ `src/cmd/go/internal/quoted`
- ❌ `src/cmd/go/internal/robustio`
- ❌ `src/cmd/go/internal/run`
- ❌ `src/cmd/go/internal/saferio`
- ❌ `src/cmd/go/internal/script`
- ❌ `src/cmd/go/internal/scripttest`
- ❌ `src/cmd/go/internal/search`
- ❌ `src/cmd/go/internal/str`
- ❌ `src/cmd/go/internal/sys`
- ❌ `src/cmd/go/internal/telemetrycmd`
- ❌ `src/cmd/go/internal/telemetrystats`
- ❌ `src/cmd/go/internal/test`
- ❌ `src/cmd/go/internal/testenv`
- ❌ `src/cmd/go/internal/testlog`
- ❌ `src/cmd/go/internal/testpty`
- ❌ `src/cmd/go/internal/tool`
- ❌ `src/cmd/go/internal/toolchain`
- ❌ `src/cmd/go/internal/trace`
- ❌ `src/cmd/go/internal/txtar`
- ❌ `src/cmd/go/internal/typesinternal`
- ❌ `src/cmd/go/internal/vcs`
...
- ❌ `src/cmd/go/internal/modfetch/deprecation.go`
...
- ❌ `src/cmd/gopls/internal/lsp/cmd/definition.go`
- ❌ `src/cmd/gopls/internal/lsp/source/hover.go`
- ❌ `src/go/doc/comment.go`
- ❌ `src/go/doc/doc.go`
- ❌ `src/golang.org/x/tools/internal/lsp/cmd/definition.go`
- ❌ `src/golang.org/x/tools/internal/lsp/source/hover.go`
...
- ❌ `src/cmd/go/internal/modload/init.go`
- ❌ `src/cmd/go/internal/modwork/initwork.go`
- ✅ `src/cmd/go/internal/workcmd/use.go`
- ❌ `src/cmd/go/internal/workcmd/work.go`
