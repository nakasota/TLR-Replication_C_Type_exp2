...
- **Number of Proposals with at least one correct link (precision > 0)**: 216
...
- ❌ `src/cmd/compile/internal/pkginit/initAsanGlobals`
- ❌ `src/internal/asan`
- ❌ `src/runtime/asan`
...
**Predicted Directories (3):**
- ❌ `src/cmd/cgo/internal/testcarchive`
...
- ❌ `src/cmd/go/internal/goexperiment`
