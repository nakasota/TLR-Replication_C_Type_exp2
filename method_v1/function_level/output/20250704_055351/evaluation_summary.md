...
- **Number of Processed Proposals**: 231
- **Number of Proposals with at least one correct link (precision > 0)**: 152
...
**Predicted Directories (4):**
- ✅ `src/go/types`
- ❌ `src/go/types/testdata/local`
- ❌ `src/go/types2`
- ❌ `src/go/types2/testdata/local`
...
- ❌ `src/cmd/cgo/main.go`
- ✅ `src/cmd/cgo/out.go`
- ❌ `src/cmd/compile/internal/typecheck/notinheap.go`
...
- ❌ `src/runtime/syscall_asm_amd64.s`
...
**Predicted Files (5):**
- ❌ `src/cmd/compile/internal/ssagen/unsafe.go`
...
- ❌ `src/cmd/compile/internal/types2/typeparam.go`
- ❌ `src/cmd/compile/internal/types2/typeparams.go`
- ❌ `src/go/parser/parser.go`
- ❌ `src/go/types/typelists.go`
- ❌ `src/go/types/typeparam.go`
...
**Predicted Files (12):**
- ❌ `doc/go1.15.html`
- ❌ `src/cmd/compile/internal/386/ssa.go`
...
- ❌ `src/cmd/go/go.go`
- ❌ `src/cmd/go/internal/base/base.go`
- ❌ `src/cmd/go/internal/cmdflag/cmdflag.go`
- ❌ `src/cmd/go/main.go`
