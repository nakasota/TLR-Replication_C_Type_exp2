...
- **Number of Processed Proposals**: 231
- **Number of Proposals with at least one correct link (precision > 0)**: 151
...
- **File:** `src/cmd/go/internal/work/cover.go`
    - Ground Truth Functions (0):
    - Predicted Functions (3):
...
- **File:** `src/internal/poll/fd_poll_runtime.go`
    - Ground Truth Functions (0):
    - Predicted Functions (2):
        - ❌ `runtime_pollOpen`
...
- **File:** `src/time/zoneinfo_plan9.go`
    - Ground Truth Functions (0):
    - Predicted Functions (3):
        - ❌ `initLocal`
        - ❌ `loadZoneDataPlan9`
...
- **File:** `src/cmd/go/internal/modget/get.go`
    - Ground Truth Functions (0):
    - Predicted Functions (5):
        - ❌ `func (recv)  bool, m module.V(...)`
        - ❌ `func (recv) , queries []*q(...)`
        - ❌ `func (recv) des []pathSet(...)`
        - ❌ `func (recv) et, isPackag(...)`
        - ❌ `func (recv) patterns []s(...)`
...
- ❌ `src/cmd/compile/internal/walk/unsafe.go`
- ❌ `src/runtime/slice.go`
- ❌ `src/unsafe/unsafe.go`
...
- ❌ `src/cmd/go/internal/modfile/parser.go`
...
- ❌ `src/cmd/go/internal/modload/list.go`
- ✅ `src/cmd/go/internal/work/build.go`
- ❌ `src/cmd/go/internal/work/get.go`
- ❌ `src/cmd/go/internal/work/install.go`
...
**Predicted Files (2):**
- ❌ `src/testing/internal/internal.go`
- ✅ `src/testing/testing.go`
...
- ❌ `src/cmd/compile/internal/ssagen/init.go`
- ❌ `src/cmd/dist/build.go`
- ❌ `src/cmd/go/internal/work/exec.go`
- ❌ `src/cmd/go/internal/work/init.go`
...
- ❌ `src/cmd/compile/internal/typecheck/conversions.go`
- ❌ `src/cmd/compile/internal/typecheck/typecheck.go`
